document.addEventListener("DOMContentLoaded",()=>{
    ...
    products.forEach(product => {
        ...
        li.innerHTML = `
            <a href="/EsteeLauder/detail_page/beautiful_detail.html?cid=${product.code}">
                <figure class="product-img">
                    <img src="/EsteeLauder/resource/perfume/collection/beautiful/${product.thmb}" alt="${product.name}">
                </figure>
                <div class="title">
                    <section>
                        <h3>${product.name}</h3>
