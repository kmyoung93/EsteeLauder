document.addEventListener("DOMContentLoaded",()=>{
    ...
    products.forEach(product => {
        ...
        li.innerHTML = `
            <a href="/EsteeLauder/detail_page/morden_detail.html?cid=${product.code}">
                <figure class="product-img">
                    <img src="/EsteeLauder/resource/perfume/collection/morden/${product.thmb}" alt="${product.name}">
                </figure>
                <div class="title">
                    <section>
                        <h3>${product.name}</h3>
